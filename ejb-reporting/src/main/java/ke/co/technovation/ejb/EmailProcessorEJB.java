...
public class EmailProcessorEJB {
	...
	public static final ScheduleExpression scheduleExpression = new ScheduleExpression().hour("*").minute("*").second("*/30");
	{
		statuses.add(ProcessingStatus.JUST_IN);
		statuses.add(ProcessingStatus.PROCESSED_IN_ERROR);
		timerConfig.setInfo("Every 30 second timer");
	...
	public void programmaticTimout(Timer timer) {
		...
		try {
			...
			//Mail mailTimo = createMail();
			//mailDAO.save(mailTimo);
	...
	private Mail createMail() {
		Mail mail = new Mail();
		mail.setBody("Dear Timo. <br/> This is an email generated by scheduler on "+(new Date())+"<br/>");
		mail.setEmail("timomwa@gmail.com");
		mail.setSubject("Listner alert on "+(new Date()));
		return mail;
	}
